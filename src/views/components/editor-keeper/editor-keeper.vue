...
import EditorKeeperService from "./editor-keeper-service"
...
onMounted(() => {
  const editorInstance = editorKeeperService.getEditorInstance(props.tabId, { ...props, ...attrs })
  editorKeeper.value?.appendChild(editorInstance)
  /**
